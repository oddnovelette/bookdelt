...
@section('content')
    ...
    <div class="d-flex flex-row mb-3">
        <a href="{{ route('admin.regions.edit', $region) }}" class="btn btn-primary mr-1"><i class="fa fa-pencil"></i> Edit</a>
    ...
    <p>
        <a href="{{ route('admin.regions.create', ['parent' => $region->id]) }}" class="btn btn-info">
            <i class="fa fa-plus"></i> Add SubRegion
        </a>
    </p>
